<x-student-layout>
    <div class="max-w-6xl w-full px-6 py-12 flex flex-col items-center">
        ...
        <h1 class="text-3xl font-black text-slate-800 dark:text-white uppercase mb-8 tracking-tighter">
            Tahap 1: Membaca - {{ $materi->judul }}
        </h1>

        <!-- Video Player -->
        <div class="w-full aspect-video bg-black rounded-[3rem] border-8 border-slate-800 overflow-hidden shadow-2xl mb-8">
        ...
        <!-- Teks Bacaan -->
        <div class="w-full bg-white dark:bg-slate-900 p-10 rounded-[3rem] border-4 border-slate-200 dark:border-slate-800 shadow-xl mb-10">
