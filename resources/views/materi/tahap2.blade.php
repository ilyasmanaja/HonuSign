<x-student-layout>
    <div class="max-w-5xl mx-auto w-full px-6 py-12 flex flex-col items-center">
        ...
        @if($quiz->tipe == 'puzzle')
            <div class="w-full max-w-5xl flex flex-col lg:flex-row gap-8 items-center lg:items-start justify-center mb-10">
                ...
                <div
                    ...
                    <!-- Board Grid -->
                    <div id="puzzle-grid"
                        class="grid grid-cols-3 gap-1 bg-white p-2 brutal-border brutal-shadow-sm rounded-2xl overflow-hidden aspect-video w-full max-w-[500px]">
                        @php
                            $pieces = range(0, 8);
                            shuffle($pieces);
                        @endphp
