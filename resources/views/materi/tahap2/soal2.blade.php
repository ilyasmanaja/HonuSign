...
<body class="selection:bg-transparent transition-transform">
    ...
    <div
        ...
        <div
            class="w-full lg:w-1/2 flex flex-col items-center justify-center bg-[#BEE9E8] brutal-border brutal-shadow rounded-[2rem] p-6 lg:p-8">
        ...
        <div class="w-full lg:w-1/2 flex flex-col gap-6 justify-between">
            ...
            <div
                class="bg-[#FFFEFA] brutal-border brutal-shadow rounded-[2rem] p-6 flex flex-col items-center justify-center">
                ...
                <div
                    ...
                    <img id="reference-img" src="{{ asset('images/materi/tahap1/pakaian_adat.png') }}"
                        alt="Referensi Pakaian Adat" class="w-full h-full object-cover">
                </div>
            </div>

            <!-- Controls Panel -->
            <div
                class="bg-[#E0BBE4] brutal-border brutal-shadow rounded-[2rem] p-6 flex flex-col gap-5 justify-between">
                <!-- Moves counter -->
                ...
                <!-- Action Button Controls (Grid disesuaikan menjadi 2 kolom agar seimbang) -->
                <div class="grid grid-cols-2 gap-4 mt-1">
                    <!-- Shuffle Button with Tooltip -->
                    <div class="relative group/tooltip">
                        <button id="btn-shuffle" aria-label="Acak"
                            class="w-full bg-[#FFF5B8] brutal-border brutal-shadow-sm brutal-hover py-3.5 rounded-2xl flex items-center justify-center cursor-pointer text-black">
                    ...
                    <div class="relative group/tooltip">
                        <button id="btn-hint" aria-label="Bantuan"
                            class="w-full bg-[#BEE9E8] brutal-border brutal-shadow-sm brutal-hover py-3.5 rounded-2xl flex items-center justify-center cursor-pointer text-black">
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" class="w-6 h-6 text-black"
