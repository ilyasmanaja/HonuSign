    ...
    <div class="max-w-5xl w-full px-6 py-12 flex flex-col items-center">
        ...
        <div class="w-full mb-10">
            <div class="flex justify-between mb-2">
                <span class="text-xs font-black text-blue-600 uppercase tracking-widest">Tahap 3: Diskusi</span>
            ...
            <div class="w-full bg-slate-200 h-3 rounded-full overflow-hidden border-2 border-white">
                <div class="bg-blue-500 h-full w-[50%] transition-all duration-1000"></div>
            </div>
        </div>

        <h1 class="text-3xl font-black text-slate-800 uppercase mb-8">Ayo Membaca! 📖</h1>

        <div class="w-6xl bg-white dark:bg-slate-900 p-10 rounded-[3rem] border-4 border-slate-200 shadow-xl mb-10">
        ...
        <a href="{{ route('materi.belajar', ['step' => 3, 'soal_ke' => 1]) }}"
            ...
            class="bg-blue-600 hover:bg-blue-500 text-white p-8 px-12 rounded-[2.5rem] font-black uppercase active:translate-y-2 transition-all mt-8">
